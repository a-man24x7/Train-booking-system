...
import com.aman.utility.DBUtil;
...
public class TrainServiceImpl implements TrainService {
    ...
    public String addTrain(TrainBean train) {
        ...
        // This method in your interface does declare throws TrainException,
        // but original implementation returned a response string.
        // We'll keep returning response string and handle SQLExceptions here.
    ...
    public TrainBean getTrainById(String trainNo) throws TrainException {
        ...
        try (Connection con = DBUtil.getConnection();
            ...
            // Convert SQL exception to domain exception as method declares throws TrainException
